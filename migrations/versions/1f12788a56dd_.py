...
Revision ID: 1f12788a56dd
Revises: 
Create Date: 2024-12-12 12:34:55.915768
...
def upgrade():
    ...
    sa.Column('playlist_sort_order', sa.String(length=15), nullable=True),
    ...
    sa.Column('song_id', sa.Integer(), nullable=False),
    sa.Column('song_order', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['playlist_id'], ['playlists.id'], ),
    sa.ForeignKeyConstraint(['song_id'], ['songs.id'], ),
    sa.PrimaryKeyConstraint('playlist_id', 'song_id', 'song_order')
    )
    if environment == 'production':
